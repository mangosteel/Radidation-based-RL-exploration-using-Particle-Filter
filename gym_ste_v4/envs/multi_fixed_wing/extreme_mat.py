...
class StePfMvgConvMultiExtMatEnv(BaseEnv):
    ...
    def __init__(self):
        ...
        mat_file = scipy.io.loadmat('/root/gym_ste_v4/gym_ste_v4/envs/common/mat_files/random_states_rate.mat')
...
register(
    id='StePfMvgConvMultiExtMatEnv-v0',
    entry_point='gym_ste_v4.envs.pf_mvg_conv_multi:StePfMvgConvMultiExtMatEnv',
)
